1. Markteintritt ohne Umbau. Jeder neue Markt – Schweiz, Österreich, ein US-Pilot – ist ein Paket, kein Entwicklungsprojekt. Das ist der Unterschied zwischen zwei Wochen Datenpflege und sechs Monaten Code, und es bedeutet, dass ihr einen Schweizer Kunden annehmen könnt, bevor ihr einen habt. Ohne PEX wäre jedes Land ein Fork, und Forks sterben.

2. Bundesländer werden Konfiguration. Hamburg und Bayern unterscheiden sich in Schulformen, Übertritt, Abschlussprüfungen und Recht – und ihr habt Kunden in beiden. Heute steckt dieser Unterschied in Köpfen und in Freitextfeldern. Mit PEX steckt er in 100 Zeilen, die jemand einmal richtig pflegt.

3. Weniger Sonderfälle im Code. Notenskala, Zeugnisrhythmus, Fächernamen, Begriffe – alles, was heute in Bedingungen wie „wenn Schweiz, dann Note 6 ist gut" landen würde, liegt in Daten. Der Code stellt die Frage („was ist die beste Note?"), das Paket antwortet. Das hält die Codebasis klein, und Kleinheit ist bei eurem Team der wichtigste Vorteil überhaupt.

4. Ein Ort für Rechtsbezüge. Datenschutz-Handbuch, Konzept-Verankerung, Nachweisbericht, Schutzkonzept – alle brauchen „welches Schulgesetz, welche Aufsicht, welche Aufbewahrungsfrist". Mit legal steht das einmal im Paket, statt in vier Modulen zu driften. Das ist zugleich die Antwort auf die R1-Abhängigkeit der Konzept-Verankerung: kuratierter Fachinhalt je Bundesland hat jetzt ein Format.

5. Freie Schulen sind sauber abbildbar. Anerkannte vs. genehmigte Ersatzschule, Abschluss im Haus oder als Externenprüfung, Textzeugnis, Epochen – das ist euer Kernmarkt, und Standardsoftware kennt ihn nicht. PEX kennt ihn als Overlay. Das ist ein Verkaufsargument gegenüber jeder Waldorfschule, die sich in anderen Systemen als Ausnahme fühlt.

6. Kunden und Verbände können mitpflegen. Ein Kanton, ein Waldorf-Bund, ein Landesverband freier Schulen kann sein Overlay selbst korrigieren – und mit einer offenen Lizenz will er das auch. Ihr werdet zum Ort, an dem das Wissen liegt, ohne es allein tragen zu müssen.

7. Ein offenes Format ist Marketing und Schutz zugleich. „Prilog Education Exchange" auf GitHub, mit Paketen für vier Länder, ist etwas, worüber Bildungsverwaltungen und Fachpresse reden. Und ein Format, das andere adoptieren, macht Prilog schwerer ersetzbar – die Daten sind portabel, aber ihr habt sie zuerst gehabt und definiert ihre Struktur.

8. Es zwingt zur Sauberkeit. Das ist der stille Vorteil: PEX hat euch zum Einschreibungs-Modell geführt, das ihr für die Kursoberstufe ohnehin braucht. Ein Format, das Länder trennt, deckt auf, was im Kern zu eng ist.
